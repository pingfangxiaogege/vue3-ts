...
import { IBase, CLoginRes, IMenu } from './response-type'
export const baseUrl =  '/redmond-organization'
...
export default {
  ...
  getMenuList(): Promise<IBase<IMenu[]>> {
    return axios.post(`${baseUrl}/roleMenu/selectCurrentMenuTree`, {})
  }
}